            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="../admins/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{url('admins/index')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{url('admins/products')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Product</a>
                    <a href="{{url('admins/categories')}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Category</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">{{Session::get('adminLogin')}}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="{{url('admins/logout')}}" class="dropdown-item">Log Out</a>
                            <a href="{{url('admins/admin-profile/'.$data->adminID )}}" class="dropdown-item">Profile</a>
                        </div>
                    </div>
                </div>
            </nav>
